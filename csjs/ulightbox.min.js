...
function setTextSize(size) {
    ...
    if (size === 'small') {
        ...
        root.style.setProperty('--tpl-font-size', '13px');
        root.style.setProperty('--tpl-font-size-plus', '17px');
        root.style.setProperty('--tpl-font-size-medium', '13px');
        root.style.setProperty('--tpl-font-size-medium-plus', '13px');
        root.style.setProperty('--tpl-font-size-large', '26px');
       ...
       root.style.setProperty('--tpl-font-size-extra-small', '15px');
        ...
        root.style.setProperty('--tpl-font-size-plus', '20px');
        ...
        root.style.setProperty('--tpl-font-size-extra-large', '22px');
    }
...
function setTextColor(color) {
    ...
    if (color === 'standard') {
        root.style.setProperty('--link-a', '#683AB7');
        root.style.setProperty('--link-b', '#8459CF');
        root.style.setProperty('--link-c', '#906BCF');
        root.style.setProperty('--link-a-hover', '#906BCF');
        root.style.setProperty('--link-b-hover', '#A685DF');
        root.style.setProperty('--link-c-hover', '#AF93DF');
    } else if (color === 'blue') {
        root.style.setProperty('--link-a', '#3f51b5');
        root.style.setProperty('--link-b', '#5E6FCD');
        root.style.setProperty('--link-c', '#6F7ECD');
        root.style.setProperty('--link-a-hover', '#6F7ECD');
        root.style.setProperty('--link-b-hover', '#8996DE');
        root.style.setProperty('--link-c-hover', '#96A1DE');
    } else if (color === 'teal') {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultColor = 'standard'; // Стандартный цвет
    const defaultWidth = 'wide'; // Стандартная ширина
