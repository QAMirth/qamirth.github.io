...
function setTextSize(size) {
    ...
    if (size === 'small') {
        ...
        root.style.setProperty('--tpl-font-size-medium-plus', '18px');
        ...
        root.style.setProperty('--tpl-font-size-large', '33px');
...
function setTextColor(color) {
    ...
    if (color === 'standart') {
        root.style.setProperty('--link-a', '#644DF7');
        root.style.setProperty('--link-b', '#7E6AFA');
        root.style.setProperty('--link-c', '#9181FA');
        root.style.setProperty('--link-a-hover', '#9181FA');
        root.style.setProperty('--link-b-hover', '#A496FC');
        root.style.setProperty('--link-c-hover', '#A496FC');
    } else if (color === 'blue') {
