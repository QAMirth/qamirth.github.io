...
function setTextColor(color) {
    ...
    if (color === 'violet') {
        ...
        root.style.setProperty('--link-a', '#0000EE');
        root.style.setProperty('--link-b', '#2828F4');
        root.style.setProperty('--link-c', '#4848F4');
        root.style.setProperty('--link-a-hover', '#4848F4');
        root.style.setProperty('--link-b-hover', '#6666F8');
        root.style.setProperty('--link-c-hover', '#6666F8');
    } else if (color === 'teal') {
