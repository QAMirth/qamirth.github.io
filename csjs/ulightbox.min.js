...
function setTextColor(color) {
    ...
    if (color === 'violet') {
        root.style.setProperty('--link-a', '#6600ED');
        root.style.setProperty('--link-b', '#7F28F3');
        root.style.setProperty('--link-c', '#9148F3');
        root.style.setProperty('--link-a-hover', '#9148F3');
        root.style.setProperty('--link-b-hover', '#A466F7');
        root.style.setProperty('--link-c-hover', '#A466F7');
