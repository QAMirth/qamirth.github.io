...
<div class="set-icon" id="setIcon">
<svg class="user-pref" id="Capa_2" xmlns="http://www.w3.org/2000/svg" width="21px" height="21px" viewBox="0 0 83.848 83.848" xml:space="preserve">
<g>
	<g>
